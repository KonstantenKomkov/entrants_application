...
отсутствует файл конфигурации [db.py][6] (можно взять из репозитория web2py), его необходимо будет настроить. При разработке особое внимание уделялось серверной части: соответствие PEP8, оптимизации количества SQL запросов и их кешированию.  
